...
public class Phase {
    ...
    public void applyTimestamp(double gpssoc, long gpsfracsec) {
        ...
        gpsoffset_ns = ((gpssoc - srcsoc) * time_base) + gpsfracsec - srcfracsec - spoof;    // number of fracs (e.g. nano seconds)
    ...
    public static double adjSpoofing(double ns) {
        spoof += ns;
        return spoof;
    }

    public static void resetSpoof() {
        spoof = 0;
    }
}
